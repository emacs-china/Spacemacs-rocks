...
- [[https://www.bilibili.com/video/BV1Yi4y117PQ/][Bilibili]]
- [[https://www.youtube.com/watch?v=4MqK2_N1y4I][Youtube]]
...
** 使用 Org 来管理配置文件
使用 magit 切换分支到 master，然后新建一个 org-config 分支：
...
#+begin_src emacs-lisp
    ...
    :straight (:host github :repo "glen-dai/highlight-global"))
#+end_src
